...
struct ChildWidget {
    widget: WidgetPod<DruidAppData, AnyWidget>,
    params: FlexParams,
}
...
impl ChildWidget {
    fn new(child: AnyWidget, params: FlexParams) -> Self {
        ChildWidget {
...
impl Flex {
    ...
    pub fn with_child(mut self, child: AnyWidget) -> Self {
    ...
    /// [`CrossAxisAlignment`]: enum.CrossAxisAlignment.html
    pub fn with_flex_child(mut self, child: AnyWidget, params: impl Into<FlexParams>) -> Self {
        self.add_flex_child(child, params);
        self
    }

    // TODO: see below regarding spacers.
    ...
    */
    ...
    pub fn add_child(&mut self, child: AnyWidget) {
        self.add_flex_child(child, 0.0);
    }
    ...
    pub fn add_flex_child(&mut self, child: AnyWidget, params: impl Into<FlexParams>) {
        let child = ChildWidget::new(child, params.into());
        self.children.push(child);
    }

    // TODO: spacers can definitely be added back, just need to make them variants
    // of AnyWidget.
        ...
        for item in mut_iter {
            match item {
                ...
                MutIterItem::Insert(id, body, child_iter) => {
                    ...
                    self.children.insert(ix, child_widget);
                    ix += 1;
                    children_changed = true;
                }
...
impl Widget<DruidAppData> for Flex {
